...
class JobOffersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_offer" do
    assert_difference('JobOffer.count') do
      post job_offers_url, params: { job_offer: { company_id: @job_offer.company_id, description: @job_offer.description, location: @job_offer.location, position: @job_offer.position, salary: @job_offer.salary, skills: @job_offer.skills } }
    end
  ...
  test "should update job_offer" do
    patch job_offer_url(@job_offer), params: { job_offer: { company_id: @job_offer.company_id, description: @job_offer.description, location: @job_offer.location, position: @job_offer.position, salary: @job_offer.salary, skills: @job_offer.skills } }
